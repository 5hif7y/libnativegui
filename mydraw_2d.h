...
extern void set_black(int d);
extern void set_white(int d);
extern void set_red(int d);
extern void set_green(int d);
extern void set_blue(int d);
extern void set_yellow(int d);

// German compatibility aliases
extern int schwarz();
extern int weiss();
extern int rot();
extern int gruen();
