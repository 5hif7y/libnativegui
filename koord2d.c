			 ...
			 char *xstr, char *ystr)
{
  ...
  if (!initialisiert){
    ...
    sprintf(label[0],"%s [%s]",xstr,strexp[0]);
    sprintf(label[1],"%s [%s]",ystr,strexp[1]);
  ...
  strl+=4;
  strl*=textsize;
  /*if (drawmask&labelyl)*/ *xofs =2* strl;/* else *xofs=0;*/
  /*if (drawmask&labelyr)*/ *xsize-=1.1* *xofs;/* else *xsize-=*xofs;*/
  /*if (drawmask&labelxu)*/ *yofs =0.1*8*textsize; /* else *yofs=0;*/
  /*if (drawmask&labelxd)*/ *ysize-=8*textsize;/* else *ysize-=*yofs;*/
  /*if (drawmask&drawxu)*/
