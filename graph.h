...
typedef struct _grvecdat {
  int veccol1,veccol2,vecstep;
  double vecangle,vecwidth;
} grvecdat;
...
typedef struct _grstr {  
  int anzN_R,maxanzN_R,          /*2d-curve*/
      ...
      anzN_RxRxR,maxanzN_RxRxR,  /*3-d curve */
      anzN_RxRxRp,maxanzN_RxRxRp,  /*3-d curve */
  ...
  char **N_Rname,**N_Rnamep,**N_RxRname,**N_RxRpname,**N_RxRxRname,**N_RxRxRpname,**N_RxRxRxRname,
       **N_Nname,
       **NxN_Rname,**NxN_Rpname,**NxN_RxRname,**NxN_RxRpname,**NxN_RxRxRtname,
    **NxN_Nname,
       **NxNxN_Rname,**NxNxN_Rnamep,**NxNxN_RxRname,
       **cont3dname;
  double **pN_R,***pN_Rp,**pN_RxR,***pN_RxRp,**pN_RxRxR,**pN_RxRxRp,**pN_RxRxRxR,
    **pNxN_R,***pNxN_Rp,**pNxN_RxR,***pNxN_RxRp,**pNxN_RxRxRt,
    **pNxN_RxRxR,
    **pNxNxN_R,***pNxNxN_Rp,**pNxNxN_RxRxR;
  int **pN_N,**pNxN_N;
  grdat *dN_R,*dN_Rp,*dN_RxR,*dN_RxRxR,*dN_RxRxRp,*dN_RxRp,*dN_RxRxRxR,*dN_N,*dN_NxN; /* only some types require these data */
  grvecdat *dNxN_RxR,*dNxN_RxRp;
  Contour ***pcont3d;
  dim1    *dimN_R,*dimN_Rp,*dimN_RxR,*dimN_RxRp,*dimN_RxRxR,*dimN_RxRxRp,*dimN_RxRxRxR,*dimN_N;
  dim2    *dimNxN_R,*dimNxN_Rp,*dimNxN_RxR,*dimNxN_RxRp,*dimNxN_RxRxRt,*dimNxN_N;
  dim3    *dimNxNxN_R,*dimNxNxN_Rp,*dimNxNxN_RxRxR,*dimcont3d;
  int **reqN_R,**reqN_Rp,**reqN_RxR,**reqN_RxRp,**reqN_RxRxR,**reqN_RxRxRp,**reqN_RxRxRxR,
    **reqN_N,
    **reqNxN_R,**reqNxN_Rp,
...
extern void DefineGraphN_RxRxR(char *Name,double *gd,int *dim,int *req);
...
extern void DefineGraphN_N(char *Name,int *gd,int *dim,int *req);
...
extern void DefineGraphNxN_RxR(char *Name,double *gd,
                      int *dim1,int *dim2,int *req);
extern void DefineGraphNxN_RxRp(char *Name,double **gd,
                      int *dim1,int *dim2,int *req);
